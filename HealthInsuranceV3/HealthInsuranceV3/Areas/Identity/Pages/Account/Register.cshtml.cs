...
namespace HealthInsuranceV3.Areas.Identity.Pages.Account
{
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var findUser = await _userManager.FindByEmailAsync(Input.Email);
                    if (findUser != null)
                    {
                        // Update the EmployeeId in the DepartmentManager table
                        ...
                        // Save the DepartmentManager record to the database
